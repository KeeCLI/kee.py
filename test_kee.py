...
region = us-west-2"""
        ...
        lines = content.split('\n')
        profile_indices = [i for i, line in enumerate(lines) if line.startswith('[profile')]
...
class TestKeeManager(unittest.TestCase):
    ...
    @patch('kee.KeeConfig')
    @patch('kee.AWSConfigManager')
    def test_add_account_success(self, mock_aws_config, mock_kee_config,
                                mock_check_creds, mock_read_profile, mock_subprocess):
        ...
        mock_config_instance.load_config.return_value = {'accounts': {}, 'current_account': None}
    ...
    @patch('kee.KeeConfig')
    @patch('kee.AWSConfigManager')
    def test_add_account_sso_failure(self, mock_aws_config, mock_kee_config, mock_subprocess):
    ...
    @patch('kee.KeeConfig')
    @patch('kee.AWSConfigManager')
    def test_remove_account_not_found(self, mock_aws_config, mock_kee_config, mock_input):
    ...
    @patch('kee.KeeConfig')
    @patch('kee.AWSConfigManager')
    def test_remove_account_cancelled(self, mock_aws_config, mock_kee_config, mock_input):
    ...
    @patch.dict(os.environ, {'KEE_ACTIVE_SESSION': '1', 'KEE_CURRENT_ACCOUNT': 'existing'})
    @patch('kee.KeeConfig')
    @patch('kee.AWSConfigManager')
    ...
    @patch('kee.KeeConfig')
    @patch('kee.AWSConfigManager')
    def test_use_account_success(self, mock_aws_config, mock_kee_config, mock_subshell,
                                mock_sso_login, mock_check_creds, mock_subprocess):
    ...
    @patch('kee.KeeConfig')
    @patch('kee.AWSConfigManager')
    def test_check_credentials_success(self, mock_aws_config, mock_kee_config, mock_subprocess):
    ...
    @patch('kee.KeeConfig')
    @patch('kee.AWSConfigManager')
    def test_check_credentials_failure(self, mock_aws_config, mock_kee_config, mock_subprocess):
